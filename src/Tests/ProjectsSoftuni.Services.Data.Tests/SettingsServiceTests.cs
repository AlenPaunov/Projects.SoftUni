namespace ProjectsSoftuni.Services.Data.Tests
{
    ...
    public class SettingsServiceTests
    {
        ...
        {
            var options = new DbContextOptionsBuilder<ProjectsSoftuniDbContext>()
                .UseInMemoryDatabase(databaseName: "Find_User_Database") // Give a Unique name to the DB
                .Options;
            var dbContext = new ProjectsSoftuniDbContext(options);
